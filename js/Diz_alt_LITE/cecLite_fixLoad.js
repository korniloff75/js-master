...
window.Cecutient= {
	...
	ident: function (h) {
		return /js-/i.test(location.host)? h: this.author+h;
	},
...
_K.DR(function() {
	if (Cecutient.check) {
		...
		Cecutient.pc= _K.G('$head' ).cr('script',{src: Cecutient.path+'punycode.js', async:0});
		Cecutient.pc.onload= function() {
			Cecutient.db= Cecutient.pc.cr('script',{src: Cecutient.ident('/js/db/db_cecLite?req=' + _K.fns.rnd(0,1e5)), async:0},'after');
