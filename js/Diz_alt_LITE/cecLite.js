...
_K.DR(function() {
	if (Cecutient.check) {
		...
		Cecutient.db= _K.G('$head' ).cr('script',{src: Cecutient.path+'punycode.js', async:0}).cr('script',{src: Cecutient.ident('/js/db/db_cecLite?req=' + _K.fns.rnd(0,1e5)), async:0},'after');
