...
class AntimatKFF extends CommonBot
{
	const
		...
		PRETREATMENT = [
			[
				'~[a@∆]~iu','~6~','~B~','~g~','~[eєї]~iu','~[z3]~i','~[йuiі]~iu','~[o0]~i','~π|тт~i','~[p₽]~iu','~c$~i','~y|у́~i','~x|\\)\\(|\\}\\{|><~i','~R~',
				"~(.)\\1+~u",
				//* п р о б е л ы
				'~\\s+\\b(.)\\b\\s+~u',
				//* Separators
		...
		PATTERNS = [
			...
			//* блядь, пидар
			'~(?:[^аеор]|\\b)[бм]и?ля[дт]ь?|п[еи]д[ао]?р(?:\\b|а[сз]?\\b|ил)|педик|гомик~iu',
			//* ебать
			'~(?:[^вджл-нр-тч-щ]|\\b)[ьъ]?[её]б\\W*?[^ы\\b]~iu',
			//* diff
