...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ru.search-data.min.d508faf7052bad81112b5125fb3821234db5981213a2a2c327154b5009e7655f.js',function(){input.required=false;search();});}
