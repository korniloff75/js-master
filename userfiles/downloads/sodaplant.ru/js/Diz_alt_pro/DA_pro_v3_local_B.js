...
window.DizSel = window.DizSel || !!_K && {
	...
	createBGs: function () { //== Запускается ПРИ ЗАГРУЗКЕ 
		...
		DizSel.SlabovidButton = DizSel.SlabovidButton || (_K.G(DizSel.SlabovidButtonParent) || _K.G('$#header') || _K.G('$body')).cr("input", { type: 'button', class: 'imgPU no-size btn min700 DA_del', style: 'padding: 3px 5px 3px 50px; margin:0 auto; font-size:20px; background: url("' + DizSel.checkUrl + 'eye.gif") no-repeat scroll 3px center, #ddd linear-gradient(#58a, #4FAEE3) repeat scroll 0 0;border: 1px solid #58a; border-radius:5px; z-index:9949; position:static; left:5px; top:20px; cursor: url(\'' + DizSel.checkUrl + 'glasses.png\'), pointer;', id: 'diz_alt', value: 'ДЛЯ СЛАБОВИДЯЩИХ' }, "fCh");
